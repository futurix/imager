...
type
  FreeImage_OutputMessageFunction = function(fif : FREE_IMAGE_FORMAT; msg : PChar) :
                                                  pointer; stdcall;

procedure FreeImage_SetOutputMessage(omf : FreeImage_OutputMessageFunction);
            external FIDLL name 'FreeImage_OutputMessageProc';

// Allocate/Unload routines ------------------------------------------------
function FreeImage_Allocate(width, height, bpp : integer;
                            red_mask : Cardinal = 0;
                            green_mask : Cardinal = 0;
...
function FreeImage_Clone(dib : PFIBITMAP) : PFIBITMAP;
                         stdcall; external FIDLL name '_FreeImage_Clone@4';
...
function FreeImage_Load(fif : FREE_IMAGE_FORMAT;
                        filename : PChar;
...
function FreeImage_LoadFromHandle(fif : FREE_IMAGE_FORMAT; io : PFreeImageIO;
                        handle : fi_handle; flags : integer = 0) :
                        PFIBITMAP; stdcall; external FIDLL name '_FreeImage_LoadFromHandle@16';
...
function FreeImage_SaveToHandle(fif : FREE_IMAGE_FORMAT; dib : PFIBITMAP;
                                ...
                                stdcall; external FIDLL name '_FreeImage_SaveToHandle@20';

// Plugin Interface --------------------------------------------------------

function FreeImage_RegisterLocalPlugin(proc_address : FI_InitProc; format,
                    description, extension, regexpr : PChar) : FREE_IMAGE_FORMAT;
                    stdcall; external FIDLL name '_FreeImage_RegisterLocalPlugin@20';
function FreeImage_RegisterExternalPlugin(path, format, description, extension, regexpr : PChar) : FREE_IMAGE_FORMAT;
                    stdcall; external FIDLL name '_FreeImage_RegisterExternalPlugin@20';
function FreeImage_GetFIFCount : integer;
                    stdcall; external FIDLL name '_FreeImage_GetFIFCount@0';
procedure FreeImage_SetPluginEnabled(fif : FREE_IMAGE_FORMAT; enable : boolean);
                         stdcall; external FIDLL Name '_FreeImage_SetPluginEnabled@8';
function FreeImage_IsPluginEnabled(fif : FREE_IMAGE_FORMAT) : integer;
                         stdcall; external FIDLL Name '_FreeImage_IsPluginEnabled@4';
function FreeImage_GetFIFFromFormat(format : PChar) : FREE_IMAGE_FORMAT;
                         stdcall; external FIDLL Name '_FreeImage_GetFIFFromFormat@4';
function FreeImage_GetFIFFromMime(format : PChar) : FREE_IMAGE_FORMAT;
                         stdcall; external FIDLL Name '_FreeImage_GetFIFFromMime@4';
function FreeImage_GetFormatFromFIF(fif : FREE_IMAGE_FORMAT) : PChar;
                         stdcall; external FIDLL Name '_FreeImage_GetFormatFromFIF@4';
function FreeImage_GetFIFExtensionList(fif : FREE_IMAGE_FORMAT) : PChar;
                         stdcall; external FIDLL Name '_FreeImage_GetFIFExtensionList@4';
function FreeImage_GetFIFDescription(fif : FREE_IMAGE_FORMAT) : PChar;
                         stdcall; external FIDLL Name '_FreeImage_GetFIFDescription@4';
function FreeImage_GetFIFRegExpr(fif : FREE_IMAGE_FORMAT) : PChar;
                         stdcall; external FIDLL Name '_FreeImage_GetFIFRegExpr@4';
function FreeImage_GetFIFFromFilename(fif : FREE_IMAGE_FORMAT) : FREE_IMAGE_FORMAT;
                         stdcall; external FIDLL Name '_FreeImage_GetFIFFromFilename@4';
function FreeImage_FIFSupportsReading(fif : FREE_IMAGE_FORMAT) : boolean;
                         stdcall; external FIDLL Name '_FreeImage_FIFSupportsReading@4';
function FreeImage_FIFSupportsWriting(fif : FREE_IMAGE_FORMAT) : boolean;
                         stdcall; external FIDLL Name '_FreeImage_FIFSupportsWriting@4';
function FreeImage_FIFSupportsExportBPP(fif : FREE_IMAGE_FORMAT; bpp : integer) : boolean;
                         stdcall; external FIDLL Name '_FreeImage_FIFSupportsExportBPP@8';
function FreeImage_FIFSupportsICCProfiles(fif : FREE_IMAGE_FORMAT) : boolean;
                         stdcall; external FIDLL Name '_FreeImage_FIFSupportsICCProfiles@4';

// Multipaging interface ----------------------------------------------------
function FreeImage_OpenMultiBitmap(fif : FREE_IMAGE_FORMAT; filename : PChar;
                         create_new, read_only, keep_cache_in_memory : boolean) : PFIMULTIBITMAP;
                         stdcall; external FIDLL Name '_FreeImage_OpenMultiBitmap@20';

function FreeImage_CloseMultiBitmap(bitmap : PFIMULTIBITMAP; flags : integer = 0) : boolean;
                         stdcall; external FIDLL Name '_FreeImage_CloseMultiBitmap@8';

function FreeImage_GetPageCount(bitmap : PFIMULTIBITMAP) : integer;
                         stdcall; external FIDLL Name '_FreeImage_GetPageCount@4';

procedure FreeImage_AppendPage(bitmap : PFIMULTIBITMAP; data : PFIBITMAP);
                         stdcall; external FIDLL Name '_FreeImage_AppendPage@8';

procedure FreeImage_InsertPage(bitmap : PFIMULTIBITMAP; page : integer; data : PFIBITMAP);
                         stdcall; external FIDLL Name '_FreeImage_InsertPage@12';

procedure FreeImage_DeletePage(bitmap : PFIMULTIBITMAP; page : integer);
                         stdcall; external FIDLL Name '_FreeImage_DeletePage@8';

function FreeImage_LockPage(bitmap : PFIMULTIBITMAP; page : integer) : PFIBITMAP;
                         stdcall; external FIDLL Name '_FreeImage_LockPage@8';

procedure FreeImage_UnlockPage(bitmap : PFIMULTIBITMAP; page : PFIBITMAP; changed : boolean);
                         stdcall; external FIDLL Name '_FreeImage_UnlockPage@12';

procedure FreeImage_MovePage(bitmap : PFIMULTIBITMAP; target, source : integer);
                         stdcall; external FIDLL Name '_FreeImage_MovePage@12';

procedure FreeImage_GetLockedPageNumbers(bitmap : PFIMULTIBITMAP; var pages : integer; var count : integer);
                         stdcall; external FIDLL Name '_FreeImage_GetLockedPageNumbers@12';

// Filetype request routines -----------------------------------------------
function FreeImage_GetFileType(filename : PChar; size : integer) : FREE_IMAGE_FORMAT;
                            stdcall; external FIDLL name '_FreeImage_GetFileType@8';
function FreeImage_GetFileTypeFromHandle(io : PFreeImageIO;
                            handle : fi_handle; size : integer) : FREE_IMAGE_FORMAT;
                            stdcall; external FIDLL name '_FreeImage_GetFileTypeFromHandle@12';

// FreeImage info routines -------------------------------------------------
function FreeImage_GetRedMask(dib : PFIBITMAP) : cardinal;
                              stdcall; external FIDLL name '_FreeImage_GetRedMask@4';
function FreeImage_GetGreenMask(dib : PFIBITMAP) : cardinal;
                              stdcall; external FIDLL name '_FreeImage_GetGreenMask@4';
function FreeImage_GetBlueMask(dib : PFIBITMAP) : cardinal;
                              stdcall; external FIDLL name '_FreeImage_GetBlueMask@4';
function FreeImage_GetTransparencyCount(dib : PFIBITMAP) : cardinal;
                              stdcall; external FIDLL name '_FreeImage_GetTransparencyCount@4';
function FreeImage_GetTransparencyTable(dib : PFIBITMAP) : PByte;
                              stdcall; external FIDLL name '_FreeImage_GetTransparencyTable@4';
procedure FreeImage_SetTransparent(dib : PFIBITMAP; enabled : boolean);
                              stdcall; external FIDLL name '_FreeImage_SetTransparent@8';
procedure FreeImage_SetTransparencyTable(dib : PFIBITMAP; table : PByte; count : integer);
                              stdcall; external FIDLL name '_FreeImage_SetTransparencyTable@12';
function FreeImage_IsTransparent(dib : PFIBITMAP) : boolean;
                              stdcall; external FIDLL name '_FreeImage_IsTransparent@4';

// DIB info routines -------------------------------------------------------
function FreeImage_GetColorsUsed(dib : PFIBITMAP) : Cardinal;
                                stdcall; external FIDLL name '_FreeImage_GetColorsUsed@4';
function FreeImage_GetBits(dib : PFIBITMAP) : PByte;
                                stdcall; external FIDLL name '_FreeImage_GetBits@4';
function FreeImage_GetScanLine(dib : PFIBITMAP; scanline : integer) : PByte;
                                stdcall; external FIDLL name '_FreeImage_GetScanLine@8';
function FreeImage_GetBPP(dib : PFIBITMAP) : Cardinal;
                                stdcall; external FIDLL name '_FreeImage_GetBPP@4';
function FreeImage_GetWidth(dib : PFIBITMAP) : Cardinal;
                                stdcall; external FIDLL name '_FreeImage_GetWidth@4';
function FreeImage_GetHeight(dib : PFIBITMAP) : Cardinal;
                                stdcall; external FIDLL name '_FreeImage_GetHeight@4';
function FreeImage_GetLine(dib : PFIBITMAP) : Cardinal;
                                stdcall; external FIDLL name '_FreeImage_GetLine@4';
function FreeImage_GetPitch(dib : PFIBITMAP) : Cardinal;
                                stdcall; external FIDLL name '_FreeImage_GetPitch@4';
function FreeImage_GetDIBSize(dib : PFIBITMAP) : Cardinal;
                                stdcall; external FIDLL name '_FreeImage_GetDIBSize@4';
function FreeImage_GetPalette(dib : PFIBITMAP) : PRGBQUAD;
                                stdcall; external FIDLL name '_FreeImage_GetPalette@4';
function FreeImage_GetDotsPerMeterX(dib : PFIBITMAP) : Cardinal;
                                stdcall; external FIDLL name '_FreeImage_GetDotsPerMeterX@4';
function FreeImage_GetDotsPerMeterY(dib : PFIBITMAP) : Cardinal;
                                stdcall; external FIDLL name '_FreeImage_GetDotsPerMeterY@4';
function FreeImage_GetInfoHeader(dib : PFIBITMAP) : PBITMAPINFOHEADER;
                                stdcall; external FIDLL name '_FreeImage_GetInfoHeader@4';
function FreeImage_GetInfo(var dib : FIBITMAP) : PBITMAPINFO;
                                stdcall; external FIDLL name '_FreeImage_GetInfo@4';
function FreeImage_GetColorType(dib : PFIBITMAP) : FREE_IMAGE_COLOR_TYPE;
                                stdcall; external FIDLL name '_FreeImage_GetColorType@4';

// ICC profile routines -----------------------------------------------------
function FreeImage_GetICCProfile(var dib : FIBITMAP) : PFIICCPROFILE;
                                stdcall; external FIDLL name '_FreeImage_GetICCProfile@4';

function FreeImage_CreateICCProfile(var dib : FIBITMAP; data : pointer; size : longint) : PFIICCPROFILE;
                                stdcall; external FIDLL name 'FreeImage_CreateICCProfile@12';

procedure FreeImage_DestroyICCProfile(var dib : FIBITMAP);
                                stdcall; external FIDLL name 'FreeImage_DestroyICCProfile@4';
...
function FreeImage_Threshold(dib : PFIBITMAP; quantize : FREE_IMAGE_QUANTIZE) : PFIBITMAP;
...
function FreeImage_GetChannel(dib : PFIBITMAP; channel : FREE_IMAGE_COLOR_CHANNEL) : PFIBITMAP;
                                stdcall; external FIDLL name '_FreeImage_GetChannel@8';
function FreeImage_SetChannel(dib, dib8 : PFIBITMAP; channel : FREE_IMAGE_COLOR_CHANNEL) : Boolean;
                                stdcall; external FIDLL name '_FreeImage_SetChannel@12';
// copy / paste routines
function FreeImage_Copy(dib : PFIBITMAP; left, top, right, bottom : Integer) : PFIBITMAP;
                                stdcall; external FIDLL name '_FreeImage_Copy@20';
function FreeImage_Paste(dst, src : PFIBITMAP; left, top, alpha : Integer) : Boolean;
                                stdcall; external FIDLL name '_FreeImage_Paste@20';
{$MINENUMSIZE 1}
implementation
