...
if preview then
  ...
  else if effect='Trace' then eff.Effect_Trace(2)
  ...
  else if effect='Invert' then eff.Effect_Invert();
...
else if effect='Trace' then eff.Effect_Trace(tbrAmount.Position div 10)
else if effect='Emboss' then eff.Effect_Emboss()
