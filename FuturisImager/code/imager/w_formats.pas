...
uses
  ...
  StdCtrls, ExtCtrls, Registry, ShellAPI, ShlObj, CheckLst, c_const;
...
uses main, globals, f_strutils, f_reg, f_tools;
...
procedure TfrmFormats.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
