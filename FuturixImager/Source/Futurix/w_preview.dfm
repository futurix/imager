object frmPrintPreview: TfrmPrintPreview
  ...
  object dlgPageSetup: TPageSetupDialog
    ...
    MarginRight = 1000
    MarginBottom = 1000
    Options = [psoDefaultMinMargins, psoMargins]
    PageWidth = 21000
    PageHeight = 29700
    Left = 74
    Top = 49
  ...
  object popSetup: TPopupMenu
    TrackButton = tbLeftButton
    Left = 74
    Top = 80
    object piPrinterSetup: TMenuItem
      Caption = 'Printer'
      OnClick = piPrinterSetupClick
    end
    object piPageOptions: TMenuItem
      Caption = 'Page'
      OnClick = piPageOptionsClick
    end
  end
end
