...
Section "-FuturixImager"
  ...
  WriteRegStr   HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\FuturixImager6" "DisplayName" "FuturixImager ${FXVERSION}"
  ...
  WriteRegStr   HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\FuturixImager6" "URLUpdateInfo" "http://fximage.com/"
