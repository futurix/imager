...
procedure RestoreWindowState(	form: PForm; path: string; d_left, d_right, d_top, d_bottom: integer;
								d_flags: integer = 0; d_showcmd: integer = SW_SHOWNORMAL; prefix: string = '');
