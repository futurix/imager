...
!define MUI_WELCOMEPAGE_TITLE "FuturixImager Extras$\r$\n${FXVERSION}"
...
Section "-FuturixImagerExtras"
  ...
  WriteRegStr   HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\FuturixImagerExtras" "DisplayName" "FuturixImager Extras"
  ...
  WriteRegStr   HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\FuturixImagerExtras" "URLUpdateInfo" "http://dev.fxfp.com/"
...
Section "Support for SVG, TTF, DICOM"
  SetOutPath "$INSTDIR"
