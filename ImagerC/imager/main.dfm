object frmMain: TfrmMain
  ...
  object tbrMain: TToolBar
    ...
    object tbnWeb: TToolButton
      Left = 23
      Top = 0
      Hint = 'Web|Open image from the Web'
      Caption = 'Web'
      ImageIndex = 1
      ParentShowHint = False
      ShowHint = True
    ...
    object tbnThumb: TToolButton
      Left = 262
      Top = 0
      Hint = 'Thumbnails|File browser with preview'
      Caption = 'Thumbnails'
      ImageIndex = 12
      ParentShowHint = False
      ShowHint = True
      OnClick = miThumbClick
    end
  ...
  object sbxMain: TScrollBox
    ...
    OnMouseWheelDown = sbxMainMouseWheelDown
    OnMouseWheelUp = sbxMainMouseWheelUp
  ...
  object mnuMain: TMainMenu
    ...
    object mFile: TMenuItem
      ...
      object mSettings: TMenuItem
        ...
        object miToolLinks: TMenuItem
          Caption = 'Tool Links...'
          Hint = 'Configure tool links'
          OnClick = miToolLinksClick
        end
        object N5: TMenuItem
          Caption = '-'
        end
        object miInstalledPlugins: TMenuItem
          Caption = 'Installed Plug-ins...'
          Hint = 'View list of currently installed plug-ins'
          OnClick = miInstalledPluginsClick
        end
        ...
        object miUpdatePlugins: TMenuItem
          Caption = 'Update Plug-ins'
          Hint = 'Update plug-ins listings'
          OnClick = miUpdatePluginsClick
        end
        object miConfigurePlugins: TMenuItem
          Caption = 'Configure Plug-ins...'
          Hint = 'Change installed plug-ins settings'
          OnClick = miConfigurePluginsClick
        end
        ...
        object miClearWebCache: TMenuItem
          Caption = 'Clear Web Cache'
          Hint = 'Clear web cache'
          OnClick = miClearWebCacheClick
        end
    ...
    object mView: TMenuItem
      ...
      object mZMMethods: TMenuItem
        Caption = 'Zoom Methods'
        object miZMBox: TMenuItem
          Caption = 'Box'
          GroupIndex = 6
          RadioItem = True
          OnClick = miZMBoxClick
        end
        object miZMTriangle: TMenuItem
          Caption = 'Triangle'
          GroupIndex = 6
          RadioItem = True
          OnClick = miZMTriangleClick
        end
        object miZMHermite: TMenuItem
          Caption = 'Hermite'
          GroupIndex = 6
          RadioItem = True
          OnClick = miZMHermiteClick
        end
        object miZMBell: TMenuItem
          Caption = 'Bell'
          GroupIndex = 6
          RadioItem = True
          OnClick = miZMBellClick
        end
        object miZMSpline: TMenuItem
          Caption = 'Spline'
          GroupIndex = 6
          RadioItem = True
          OnClick = miZMSplineClick
        end
        object miZMLanczos3: TMenuItem
          Caption = 'Lanczos3'
          GroupIndex = 6
          RadioItem = True
          OnClick = miZMLanczos3Click
        end
        object miZMMitchell: TMenuItem
          Caption = 'Mitchell'
          GroupIndex = 6
          RadioItem = True
          OnClick = miZMMitchellClick
        end
      end
    ...
    object mGo: TMenuItem
      ...
      object miThumb: TMenuItem
        Caption = 'Thumbnails'
        Hint = 'File browser with preview'
        ShortCut = 113
        OnClick = miThumbClick
      end
  ...
  object imgSeek: TFileSearch
    RecurseSubFolders = False
    OnFileFind = imgSeekFileFind
    OnFinish = imgSeekFinish
    Left = 454
    Top = 195
  end
