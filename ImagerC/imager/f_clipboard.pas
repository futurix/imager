...
else if Clipboard.HasFormat(CF_METAFILEPICT) then begin
...
function IsBitmapInCB():boolean;
begin
if ((Clipboard.HasFormat(CF_BITMAP)) or (Clipboard.HasFormat(CF_METAFILEPICT))) then Result:=true else Result:=false;
end;
