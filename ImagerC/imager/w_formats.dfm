object frmFormats: TfrmFormats
  ...
  object cbxPrintEnabled: TCheckBox
    Left = 223
    Top = 172
    Width = 207
    Height = 17
    Caption = 'Add "Print" item to context menu'
    TabOrder = 8
  end
  ...
  object cbxSS: TCheckBox
    Left = 223
    Top = 208
    Width = 208
    Height = 17
    Caption = '"Slide Show" in folders context menu'
    TabOrder = 10
  end
  object cbxSSFS: TCheckBox
    Left = 223
    Top = 226
    Width = 207
    Height = 17
    Caption = 'Run slide show in full screen'
    TabOrder = 11
  end
  object cbxBrowser: TCheckBox
    Left = 223
    Top = 244
    Width = 207
    Height = 17
    Caption = '"Thumbnails" in folders context menu'
    TabOrder = 12
  end
