...
uses Windows, Graphics, SysUtils, Classes, mpLibMNG, mpMNGZLIB;
...
begin
  if stricomp (ext, 'png') = 0 then
    Result := SavePNG (img, strpas (path))
  else
    Result := 0;
end;
...
exports
  FIPISsave, FIPISopen, FIPISanimInit, FIPISanimConfirm,
