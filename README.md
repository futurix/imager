...
Back in 2001-03 **FuturixImager** used to be a Top 5 photo viewer/editor for Windows. But things have changed, photo viewers are now included with all decent operating systems - so I stopped updating Imager somewhere around 2009. It didn't help that I wrote it mostly in Delphi (a programming language that isn't that popular anymore).
