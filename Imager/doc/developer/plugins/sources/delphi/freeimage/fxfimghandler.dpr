...
begin
	...
	info_call(PT_FDESCR, 'koa', PChar(LoadLStr(1023)));
	info_call(PT_FDESCR, 'iff', PChar(LoadLStr(1024)));
	info_call(PT_FDESCR, 'ilbm', PChar(LoadLStr(1024)));
	info_call(PT_FDESCR, 'lbm', PChar(LoadLStr(1024)));
	info_call(PT_FDESCR, 'dds', PChar(LoadLStr(1025)));
	info_call(PT_FDESCR, 'ras', PChar(LoadLStr(1026)));
	info_call(PT_FDESCR, 'xbm', PChar(LoadLStr(1027)));
	info_call(PT_FDESCR, 'xpm', PChar(LoadLStr(1028)));
	info_call(PT_FDESCR, 'ico', PChar(LoadLStr(1029)));
	info_call(PT_FDESCR, 'hdr', PChar(LoadLStr(1030)));
end;
