...
uses
  ...
  Dialogs, StdCtrls, histogrambox, c_locales;
...
procedure TfrmHist.Localize();
begin
    Self.Caption			:= LoadLStr(730);
    cbxRed.Caption			:= LoadLStr(731);
    cbxGreen.Caption		:= LoadLStr(732);
    cbxBlue.Caption			:= LoadLStr(733);
    cbxGrey.Caption			:= LoadLStr(734);
