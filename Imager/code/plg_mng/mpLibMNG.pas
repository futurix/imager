...
function  mng_set_suspensionmode  (    hHandle      : mng_handle;
                                       bSuspension  : mng_bool         ) : mng_retcode;       stdcall;
...
function  mng_putchunk_ipng       (    hHandle            : mng_handle   ) : mng_retcode; stdcall;

function  mng_putchunk_ijng       (    hHandle            : mng_handle   ) : mng_retcode; stdcall;
...
function  mng_putchunk_ipng;        external mngdll;
function  mng_putchunk_ijng;        external mngdll;
